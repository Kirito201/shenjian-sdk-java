...
public class NodeInfo {
    ...
    public int getTotalGpuNodes() {
        return totalGpuNodes;
    }

    public void setTotalGpuNodes(int totalGpuNodes) {
        this.totalGpuNodes = totalGpuNodes;
    }

    public int getRunningGpuNodes() {
        return runningGpuNodes;
    }

    public void setRunningGpuNodes(int runningGpuNodes) {
        this.runningGpuNodes = runningGpuNodes;
    }
}
