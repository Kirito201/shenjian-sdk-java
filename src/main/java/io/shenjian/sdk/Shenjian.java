...
public interface Shenjian {
    ...
    /**
     * 配置指定爬虫是否遵守robots.txt
     *
     * @param appId
     * @param isAllow
     * @throws ShenjianException
     */
    void configCrawlerRobotstxt(int appId, boolean isAllow) throws ShenjianException;
     ...
     * @param url   webhook的通知地址，需要是能外网访问的地址
     * @param eventFlag webhook的标签设置
     * @param gzip 数据是否gzip压缩
     * @throws ShenjianException
     */
    void configWebhookInfo(int appId, String url, int eventFlag, boolean gzip) throws ShenjianException;
